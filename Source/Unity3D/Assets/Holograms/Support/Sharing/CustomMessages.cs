...
public class CustomMessages : Singleton<CustomMessages>
{
    ...
    public void SendMarkerList(Vector3 markerA, Vector3 markerB, byte HasAnchor)
    {
        ...
        {
         // Create an outgoing network message to contain all the info we want to send
            NetworkOutMessage msg = CreateMessage((byte)TestMessageID.MarkerList);

            AppendVector3(msg, markerA);
            AppendVector3(msg, markerB);
